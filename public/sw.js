...
const STATIC_ASSETS_TO_CACHE = [
  '/',
  '/index.html',
  '/index.tsx', // Main entry point for JS
  '/manifest.json',
  '/icons/icon-192x192.png',
  '/icons/icon-512x512.png',
  '/favicon.ico',
  // Core application files (assuming paths relative to root as requested by browser)
  '/App.tsx',
  '/types.ts',
  '/constants.ts',
  ...
  '/components/SortableTableHeader.tsx',
  '/pages/DepositsWithdrawalsPage.tsx',
  '/pages/TradesPage.tsx',
  '/pages/ReportPage.tsx',
  '/pages/SettingsPage.tsx',
  '/pages/TransactionsReportPage.tsx',
  '/pages/TradesReportDetailsPage.tsx',
  '/pages/LoginPage.tsx',
